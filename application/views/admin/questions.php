                        ...
                        <div class="col s12 m12 l9">
							<div class="card invoices-card">
                                <div class="card-content">
									...
									<h5><span class="qnum"><?php $qcount = $this->db->get_where('ffd_questions', array('exam_id' => $exam['id'])); echo $this->db->affected_rows();?></span>  Question(s) Added</h5>
							...
							<?php }
								...
								?>
								<div class="sub card invoices-card">
                                <div class="card-content">
                                    <div class="card-options">
										Question - <?php echo $i;?>
                                    </div>
                                    <span class="card-title"></span>
									<div class="row">
								<form id="sub<?php echo $i?>" method="POST" action="<?php echo base_url("index.php/dashboard/sub");?>">
										<div class="input-field col s12">
										<textarea id="details" name="question<?php echo $i;?>" rows="10" required class="materialize-textarea"></textarea>
										<label for="details">Question (<?php echo $i?>)</label>												
										</div>
										<div class="input-field col s12">
											<input id="a<?php echo $i;?>" name="ans<?php echo $i;?>" type="text" required class="">
                                            <label for="a<?php echo $i;?>">Answer</label>
                                        </div>
									<div class="input-field col s12">
												<input name="exam" type="hidden" value="<?php echo $exam['id'];?>">
										...
										<button type="submit" class="btn waves-effect teal" id="btnSub<?php echo $i;?>" style="width:100%"><i class="fa fa-plus"></i> Add</button>
									</div>
								</form>
								</div>
								</div>
							...
							<?php }
								...
								<form id="sub<?php echo $i?>" method="POST" action="<?php echo base_url("index.php/dashboard/sub");?>">
									...
									<div class="input-field col s12">
											<input id="a<?php echo $i;?>" name="ans<?php echo $i;?>" type="text" class="">
                                            <label for="a<?php echo $i;?>">Answer</label>
                                        </div>
									<div class="input-field col s12">
												<input name="exam" type="hidden" value="<?php echo $exam['id'];?>">
